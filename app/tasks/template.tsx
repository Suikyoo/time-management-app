...
export default function TemplateView() {
  ...
  return (
      <ThemedView className="h-screen w-screen bg-transparent flex flex-col justify-start items-center box-border p-4 pt-28">
        <ThemedView className="bg-white w-full aspect-square rounded-sm">
